...
<link rel="stylesheet"
	href="<c:url value='/resources/css/listPost.css' />">
					...
					<div class="card-body">
						<div class="table-responsive project-list">
							<table class="table project-table table-centered table-nowrap">
								<thead>
									<!-- <tr>
										<td colspan="3"><b><font size="6">구인 게시판</font></b></td>
									</tr> -->
									<tr>
										<th scope="col">번호</th>
										<th scope="col">분류</th>
								...
								<tbody>
									<c:forEach var="post" items="${postList}">
										<tr>
											...
											<td><a
												href="<c:url value='/findArtist/view/post'>
						...
						<div class="write-find-artist">
							<form name="listPost" method="POST">
								<a href="<c:url value='/findArtist/create/post' />"> <input
									type="button" name="writePost" value="작성"
						...
						<div class="col-sm-3">
							<form class="searchPost" method="POST"
								action="<c:url value='/findArtist/search/post' />" role="search">
