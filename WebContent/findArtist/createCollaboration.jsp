...
<body>
	...
	<br>
	<div class="container">
		<form name="createCollaborationForm" method="POST"
			action="<c:url value='/findArtist/create/collaboration' />"
			role="form" style="width: 600px; margin: 0 auto; margin-top: 40px;">
			<b><font size="6" color="black" align="center">협업 신청</font></b>
			<hr>

			<div class="required-field-block">
				<input type="text" name="collaborationTitle" class="form-control"
			...
			<div class="required-field-block">
				<textarea name="collaborationContent" rows="15" class="form-control"
					placeholder="내용을 입력해주세요."></textarea>
			</div>
			<br> <input type="text" name="postId" value="${post.postId}"
				style="display: none"> <input type="button" value="신청"
				onClick="collaborationCreate()" class="btn btn-primary"> <br>
		</form>
	</div>
</body>
</html>